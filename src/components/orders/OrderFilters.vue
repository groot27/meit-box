...
<template>
  <div class="bg-white border-r border-gray-200 p-6 w-80">
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          @input="handleFilterChange('startDate', ($event.target as HTMLInputElement).value)"
          class="input-field"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          @input="handleFilterChange('endDate', ($event.target as HTMLInputElement).value)"
          class="input-field"
        />
      </div>
      ...
      <div>
        ...
        <select
          ...
          @change="handleFilterChange('orderStatus', ($event.target as HTMLSelectElement).value)"
          class="input-field"
        >
          <option
      ...
      <div>
        ...
        <select
          ...
          @change="handleFilterChange('orderCategory', ($event.target as HTMLSelectElement).value)"
          class="input-field"
        >
          <option
